  ...
  return (
    <section className="services py-16 px-8 text-center bg-gray-100">
      ...
      <div className="services-container flex flex-wrap space-x-8 px-4 py-4 justify-center items-center">
        <div className="service-card cursor-pointer bg-white p-6 rounded-lg shadow-lg transform transition-all hover:bg-blue-400 hover:translate-y-[-10px] group flex-shrink-0 w-64 mb-4" onClick={() => navigate("/ServicesPage")}>
